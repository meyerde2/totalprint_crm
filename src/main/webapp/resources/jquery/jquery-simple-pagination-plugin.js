	...
	return this.each(function()
	{
		...
		function refresh_page_numbers(page_number)
		{
			...
			var half_of_number_of_page_numbers_visable = Math.ceil(number_of_visible_page_numbers / 2) - 1,
				...
				{
					page_number_html = '<ul class="pagination"><li><' + settings.navigation_element + ' href="#" class="' + settings.html_prefix + '-navigation-page';
					page_number_html += page_count === 1 || page_number === current_while_page ? ' ' + settings.html_prefix + '-navigation-disabled' : '';
					page_number_html += '" data-' + settings.html_prefix + '-page-number="' + current_while_page + '">' + simple_number_formatter(current_while_page, 0, settings.thousands_separator) + '</' + settings.navigation_element + '></li></ul>';
...
$.fn.simplePagination.defaults = {
	...
	//
	first_content: 'Erste',  //e.g. '<<'
	previous_content: 'Vorherige',  //e.g. '<'
	next_content: 'Naechste',  //e.g. '>'
	last_content: 'Letzte', //e.g. '>>'
	page_x_of_x_content: 'Seite',
	showing_x_of_x_content: 'Anzeige von',
	//
